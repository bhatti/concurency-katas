defmodule Downloader do
  ...
  Download contents
  """
  def download(server_pid, url, timeout) do
    GenServer.call(server_pid, {:download, url}, timeout)
  end

  @doc """
  renders dynamic content using javascript
  """
  def jsrender(server_pid, url, contents, timeout) do
    GenServer.call(server_pid, {:jsrender, url, contents}, timeout)
  end
